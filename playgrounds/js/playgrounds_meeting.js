						...
						$('<div class="box">').append(
							...
							$('<div class="content">').append(
								$('<div class="meeting-detail">').append(
									...
									$("<a>").attr({"href": "javascript:;", "onClick": "openPage('./event_list.html')"})
...
function openPage(url) {
	...
	"height = 600, width = 1100, screenX=680, screenY=100, directories=no, depended=yes, scrollbars=yes, location=yes, menubar=yes, toolbar=no, status=no");
}
